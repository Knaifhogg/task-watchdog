...
/// Async implementation of task-watchdog for use with STM32 Embassy implementations.
pub mod embassy_stm32 {
    ...
    pub struct Stm32Watchdog {
        peripheral: Option<Peri<'static, IWDG>>,
    ...
    impl Stm32Watchdog {
        ...
        #[must_use]
        pub fn new(peripheral: Peri<'static, IWDG>) -> Self {
            Self {
        ...
        I: Id + 'static,
    {
        ...
        pub fn new(hw_watchdog: Peri<'static, IWDG>, config: WatchdogConfig<EmbassyClock>) -> Self {
